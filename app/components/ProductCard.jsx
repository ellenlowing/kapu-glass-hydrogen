...
export default function ProductCard({product, dataIndex}) {
  ...
  return (
    <Link id={dataIndex} to={`/products/${product.handle}`} 
      className={`product group hover:col-unset hover:bg-unset ${isMobile ? 'w-[100px]' : 'w-[160px] md:w-[180px]'} offset-0 absolute hover:scale-[2] origin-bottom z-50 transition ease-in-out duration-50`}>
